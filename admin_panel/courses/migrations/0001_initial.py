    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(decimal_places=2, default=0.0, help_text='Course price in UZS', max_digits=9, validators=[django.core.validators.MinValueValidator(0)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telegram_xideo_id', models.CharField(help_text='Video ID from Telegram', max_length=255, verbose_name='Telegram Video ID')),
