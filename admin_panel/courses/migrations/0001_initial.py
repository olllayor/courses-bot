    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(decimal_places=2, default=Decimal('0.00'), help_text='Course price in UZS', max_digits=10, validators=[django.core.validators.MinValueValidator(Decimal('0.00'))])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telegram_video_id', models.CharField(blank=True, help_text='Video ID from Telegram', max_length=255, null=True, verbose_name='Telegram Video ID')),
