...
class QuizAdmin(admin.ModelAdmin):
    list_display = ["lesson", "id", "question_count"]
    ...
    fieldsets = (
        ...
        (
            "Quiz Content",
            {
                "fields": ("questions", "answers", "correct_answers"),
                "description": "Enter questions, possible answers, and correct answer indices in JSON format",
            },
        ),
    )
